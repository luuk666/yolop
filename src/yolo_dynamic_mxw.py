                                ...
                                for i in np.linspace(x1,x2,x2-x1):
                                    for j in np.linspace(y1,y2,y2-y1):
                                        ...
                                        if (rank_2[int(j-1)][int(i-1)]==0.1):
                                            rank_2[int(j-1)][int(i-1)]=int(z*1000*200*50)*0.00001
                                        else:
                                            if(rank_2[int(j-1)][int(i-1)]>=10):
                                                rank_2[int(j-1)][int(i-1)]=10
                                            if((rank_2[int(j-1)][int(i-1)]+int(z*1000*200*50)*0.000003)<1):
                                                if((rank_2[int(j-1)][int(i-1)]+int(z*1000*200*50)*0.000003)>0):
                                                    rank_2[int(j-1)][int(i-1)]=rank_2[int(j-1)][int(i-1)]+int(z*1000*200*50)*0.00003
                                                else:
                                                    rank_2[int(j-1)][int(i-1)]=1
                                            else:
                                                rank_2[int(j-1)][int(i-1)]=10
                            #rank_2=rank_2*50
                            p=p+1
